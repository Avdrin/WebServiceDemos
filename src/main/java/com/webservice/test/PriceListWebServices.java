...
public interface PriceListWebServices {
    ...
    // возвращает пустой ответ с HTTP-кодом Not Found.BigDecimal
    @GET
    String getPrice(@QueryParam("productName") String productName, @QueryParam("date") String date); //LocalDate date);
